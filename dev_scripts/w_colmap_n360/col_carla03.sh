#!/bin/bash
nrCheckpoint="/media/share_data/zhupengfei/pointnerf/my_checkpoints"
nrDataRoot="/media/share_data/colmap"
name='carla03_20220425'
resume_iter=best #
